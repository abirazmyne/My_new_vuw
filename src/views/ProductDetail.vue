                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-images">
                            <main id="gallery">
                                ...
                                <div class="images">
                                    <img v-for="(image,key5) in images" :key="key5" :src="image.image" class="img" alt="#">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <p class="category">
                                <i class="lni lni-tag"></i><a >Category : {{product.category}}</a>
                            </p>
                            <p class="category">
                                <i class="lni lni-tag"></i><a >Sub-Category : {{product.subcategory}}</a>
                            </p>
                            <p class="category">
                                <i class="lni lni-tag"></i><a >Brand :{{product.brand}}</a>
                            </p>
                    ...
                    <div class="row">
                        <div class=" col-12">
                            <div class="info-body custom-responsive-margin">
                                <h4>Details</h4>
                                <div v-html=" product.long_description">
...
<script>
    ...
    export default {
        ...
        methods: {
            getProductInfo()
            {
                axios.get("http://localhost/my_shopgrid/public/api/get--product-info/" + this.id).then((response)=> {
