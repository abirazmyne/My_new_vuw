                    ...
                    <div class="product-grids-head">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-grid" role="tabpanel" aria-labelledby="nav-grid-tab">
                                <div class="row">
                                    <div class="col-lg-4 col-md-6 col-12" v-for="(product,key3) in products" :key="key3">
                                        ...
                                        <div class="single-product">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <div class="price">
                                                    <span>{{product.selling_price}} <span class="text-danger">TK.</span></span>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="tab-pane fade" id="nav-list" role="tabpanel" aria-labelledby="nav-list-tab">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12" v-for="(product,key4) in products" :key="key4">
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-lg-8 col-md-8 col-12">
                                                    <div class="product-info">
                                                        <span class="category">{{product.category}}</span>
                                                        <h4 class="title">
                                                            <router-link to="/product-detail" >{{product.name}}</router-link>
                                                        </h4>
                                                        <ul class="review">
                                                            <li><i class="lni lni-star-filled"></i></li>
                                                            <li><i class="lni lni-star-filled"></i></li>
...
<script>
    ...
    export default {
        ...
        methods: {
            getAllProduct()
            {
                axios.get("http://localhost/my_shopgrid/public/api/get-all-category-product/" + this.id).then((response)=> {
